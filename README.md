...
# Audio y configuración post-instalación
...
# 2. Levantar servidor gráfico en modo Vulkan y configuración de entorno
vgl q 2>/dev/null
pkill -9 -f virgl 2>/dev/null
vgl angle=vulkan &
sleep 2
...
# 4. Iniciar VNC con sincronización garantizada

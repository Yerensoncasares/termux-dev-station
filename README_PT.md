...
### Fase 7: Configuração de Arranque (`xstartup` para VNC)
Se você decidir usar VNC, configure seu arquivo de início `~/.vnc/xstartup`:
...
# Localização e variáveis temporais
export LANG=pt_BR.UTF-8
export LANGUAGE=pt_BR.UTF-8
export LC_ALL=C.UTF-8
...
# Arranque limpo e nativo de XFCE
